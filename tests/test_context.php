...
$cases = [
    ...
    // Регрессия: классический редактор хранит текст БЕЗ тегов <p>, только
    // пустыми строками. Раньше вся статья была одним блоком, и ссылка в конце
    // делала «контекстом» весь текст, включая посторонние упоминания.
    ['контент без тегов <p>: ссылка не тянет за собой весь текст',
     "Иванов Иван Иванович попал под розыск.\n\nИсточник: <a href=\"https://example.org\">Издание</a>",
     'person', false],

    ['контент без тегов <p>: имя в абзаце со ссылкой ловится',
     "Обычный вводный абзац без ничего.\n\nИванов Иван Иванович <a href=\"https://example.org\">опубликовал отчёт</a>.",
     'person', true],
