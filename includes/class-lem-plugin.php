...
class LEM_Plugin {
     ...
     */
    const BUNDLED_DATA_VERSION = '1.13.0-aliases';
    ...
    public function maybe_sync_bundled_data() {
        ...
        // Алиасы, накопленные прежними версиями: городá местных отделений
        // и хвосты стран давали ложные срабатывания
        $this->importer->prune_aliases();
